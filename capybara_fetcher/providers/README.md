...
- **Automatic Chunking**: KRX source has a 2-year limit per request. The provider automatically splits longer date ranges into ~700-day chunks (safe margin under 2 years) and concatenates the results.
